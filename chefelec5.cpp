...
int main()
{
   ...
   int E,V;
    ...
    while(t--){
        ...
        for(i=lastfound+1;i<nvillage;i++){             //for connecting all 1's
            ...
            if(evillage[i]==0){
                ...
                for(j=i+1;j<nvillage;j++){
                    ...
                    if(evillage[j]==0){
                        ...
                        addEdge(graph, i, j, cvillage[j]-cvillage[i]);
                        neel[i][j]= cvillage[j]-cvillage[i];
                        i = j;
        ...
        for(i=0;i<nvillage-1;i++){
            if((evillage[i]==0 && evillage[i+1]==1) || (evillage[i]==1 && evillage[i+1]==0)){
                ...
                addEdge(graph, i, i+1, cvillage[i+1]-cvillage[i]);
                neel[i][i+1]= cvillage[i+1]-cvillage[i];
